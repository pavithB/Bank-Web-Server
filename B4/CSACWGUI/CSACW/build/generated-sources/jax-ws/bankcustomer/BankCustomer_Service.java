 ...
 * 
 */
@WebServiceClient(name = "BankCustomer", targetNamespace = "http://BankCustomer/", wsdlLocation = "http://localhost:8080/Bank_WS/BankCustomer?wsdl")
    ...
    extends Service
{
    ...
    static {
        ...
        try {
            url = new URL("http://localhost:8080/Bank_WS/BankCustomer?wsdl");
